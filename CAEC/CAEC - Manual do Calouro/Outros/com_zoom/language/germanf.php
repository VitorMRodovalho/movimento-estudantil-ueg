...
define("_ZOOM_CATSMGR_DESCR","Erstelle neue Alben f&uuml;r ihre neuen Bilder, erstelle und l&ouml;sche sie hier im Album Manager.");
...
define("_ZOOM_HD_CHECKALL","Auswählen/Abwählen alle");
define("_ZOOM_HD_CREATEDBY","Erstellt von");
define("_ZOOM_HD_AFTER","Einfügen danach");
...
define("_ZOOM_A_MESS_NOT_SHURE","* Wenn Sie sich nicht sicher sind, benutzen default \"auto\" ");
define("_ZOOM_A_MESS_SAFEMODE1","Note: \"Safe Mode\" ist aktiv, deswegen könnte es sein, dass man keine großen Datei hochladen kann!<br />Sie sollten in das Admininterface wechseln und dort zu FTP wechseln.");
...
define("_ZOOM_A_MESS_NOJAVA","Wenn Sie hier eine graue Box siehen oder Probleme beim hochladen haben, <br /> könnte es sein, dass Sie eine neuere java run-time installieren müssen. Gehen Sie auf <a href=\"http://www.java.com\" target=\"_blank\">Java.com</a> <br /> und laden Sie die neueste Version herunter.");
define("_ZOOM_SETTINGS","Einstellungen");
define("_ZOOM_SETTINGS_DESCR","betrachten und verändern Sie alle verfügbaren Konfigurationseinstellungen hier.");
...
define("_ZOOM_SETTINGS_IMGPATH","Pfad zu den Bilddateien:");
...
define("_ZOOM_SETTINGS_CSS","Stylesheet PopUp-Fenster");
define("_ZOOM_SETTINGS_USERUPL","Erlauben Sie Benutzern das Hochladen:");
define("_ZOOM_SETTINGS_ACCESSLVL","Zugriffs-Stufe: ");
...
define("_ZOOM_SETTINGS_ALLOWDEL","Benutzer erlauben, ein freigegebenes Album zu löschen");
define("_ZOOM_SETTINGS_ALLOWEDIT","Benutzern erlauben, ein Album (freigegeben) zu ändern");
...
define("_ZOOM_MOVEFILES_STEP1","Schritt 1: Wählen Sie das Ausgangsalbum");
define("_ZOOM_MOVEFILES_STEP2","Schritt 2: Wählen Sie die Bilder, die Sie verschieben möchtest");
define("_ZOOM_MOVEFILES_STEP3","Schritt 3: Wählen Sie das Zielalbum");
define("_ZOOM_ALERT_MOVEOK","Bild(er) erfolgreich verschoben!");
define("_ZOOM_OPTIMIZE","Tabellen optimieren");
define("_ZOOM_OPTIMIZE_DESCR","zOOm Gallery benutzt viele Tabellen, daher entstehen einige überschüssige Daten. Klicken Sie hier, um diese zu entfernen.");
...
define("_ZOOM_CREDITS","Über zOOm Gallery & Credits");
...
define("_ZOOM_UPLOAD_INTRO","Drücken Sie den <b>Durchsuchen</b>-Knopf, um ein Foto zum Hochladen auszuwählen.");
define("_ZOOM_UPLOAD_STEP1","1. Wählen Sie die Anzahl der Dateien, die Sie hochladen wollen: ");
define("_ZOOM_UPLOAD_STEP2","2. Wählen Sie das Album, in das Sie die Dateien ablegen wollen: ");
define("_ZOOM_UPLOAD_STEP3","3. Benutzen Sie den Durchsuchen-Knopf, um Bilder von ihrem Computer auszuwählen");
define("_ZOOM_SCAN_STEP1","Step 1: Wählen Sie einen Ort, der nach Bildern durchsucht werden soll...");
define("_ZOOM_SCAN_STEP2","Step 2: Wählen Sie die Bilder, die Sie hochladen wollen...");
define("_ZOOM_SCAN_STEP3","Step 3: zOOm verarbeitet die Bilder, die Sie ausgewählt haben...");
...
define("_ZOOM_BUTTON_SCAN","Übermittle URL oder Verzeichnis");
...
define("_ZOOM_CONFIRM_DELMEDIUM","Sie sind dabei, dieses Bild komplett zu enfernen!\\nWollen Sie wirklich fortfahren?");
define("_ZOOM_ALERT_DEL","Album ist gelöscht!");
...
define("_ZOOM_ALERT_DELPIC","Bild ist gelöscht!");
define("_ZOOM_ALERT_NODELPIC","Bild kann nicht gelöscht werden!");
define("_ZOOM_ALERT_NOPICSELECTED","Kein Bild ausgewählt.");
define("_ZOOM_ALERT_NOPICSELECTED_MULT","Kein Bild ausgewählt.");
...
define("_ZOOM_ALERT_WRONGFORMAT_MULT","Falsches Bildformat.");
define("_ZOOM_ALERT_MOVEFAILURE","Fehler beim Verschieben der Datei.");
define("_ZOOM_ALERT_IMGERROR","Fehler beim Verändern des Bildes/ Erstellung Thumbnail.");
...
define("_ZOOM_INFO_CHECKCAT","Bitte wählen Sie erst ein Album, bevor Sie den Hochladen-Knopf benutzt!");
define("_ZOOM_BUTTON_ADDIMAGES","Bilder hinzufügen");
...
define("_ZOOM_IMGFOUND","gefunden - Sie sind auf Seite");
...
define("_ZOOM_ALERT_COMMENTERROR","Sie haben bereits dieses Bild kommentiert!");
define("_ZOOM_ALERT_VOTE_OK","Ihre Bewertung wurde gespeichert! Dankeschön!");
define("_ZOOM_ALERT_VOTE_ERROR","Sie haben bereits dieses Bild bewertet!");
define("_ZOOM_WINDOW_CLOSE","Schließen");
define("_ZOOM_NOPICS","Keine Bilder im Album vorhanden");
...
define("_ZOOM_NONAME", "Sie müssen einen Namen angeben!");
...
define("_ZOOM_PASS_REQUIRED","Dieses Album benötigt ein Passwort.<br>Bitte geben Sie das Passwort ein<br>und drücken Sie den Weiter-Knopf. Dankeschön!");
...
define("_ZOOM_LIGHTBOX_ADDED","Datei erfolgreich in ihre Lightbox hinzugef&uuml;gt!");
...
define("_ZOOM_LIGHTBOX_NOZIP","Sie haben schon eine ZIP-Datei ihrer Lightbox erstellt!");
...
define("_ZOOM_AUDIO_CLICKTOPLAY","Klicke Sie hier zum abspielen.");
...
define("_ZOOM_ECARD_CLICKHERE","Klicken Sie hier um die E-Card zu sehen!");
...
define("_ZOOM_ECARD_MSG2","Klicken Sie auf den Link darunter, um Ihre persönliche E-Card zu sehen");
...
define ('_ZOOM_INSTALL_MESS1','zOOm Image Gallery wurde erfolgreich installiert.<br>Sie können nun ihre Fotos und Alben veröffentlichen!');
define ('_ZOOM_INSTALL_MESS2','Anmerkung: Das erste, was Sie jetzt tun sollten ist, in das Componenten Menü zu wechseln.<br>Suche Sie nach dem Eintrag "zOOm Media Gallery Admin", anklicken und in die <br>Einstellungen wechseln.');
define ('_ZOOM_INSTALL_MESS3','Hier können Sie alle Parameter für zOOm ändern.');
...
define ('_ZOOM_INSTALL_MESS_FAIL3','Wenn Sie diese Verzeichnisse eingerichtet haben, gehen Sie zu <br /> "Components -> zOOm Media Gallery" und ändern Sie die Einstellungen.');
