...
//Gallery admin page
if (isset($zoom) AND ($zoom->_isAdmin || $zoom->_isUser)){
...
define("_ZOOM_CATSMGR_DESCR","create new galleries for your new media, create and delete them here in the Gallery Manager.");
define("_ZOOM_NEW","New gallery");
define("_ZOOM_DEL","Delete gallery");
define("_ZOOM_MEDIAMGR","Media Manager");
define("_ZOOM_MEDIAMGR_DESCR","edit, delete, scan for media automatically or upload (multiple) new media manually.");
...
define("_ZOOM_SETTINGS_TAB4","Accessibility");
...
define("_ZOOM_SETTINGS_ACCESSLVL","Access level: ");
...
define("_ZOOM_SETTINGS_ALLOWCREATE","Allow users to create a gallery");
define("_ZOOM_SETTINGS_ALLOWDEL","Allow users to delete a shared gallery");
define("_ZOOM_SETTINGS_ALLOWEDIT","Allow users to edit a (shared) gallery");
define("_ZOOM_SETTINGS_SETMENUOPTION","Show 'Upload Media'-link in User Menu");
...
define("_ZOOM_SETTINGS_MESS_FTPHOSTDIR","Please provide the path to Mambo from your ftp-root here. IMPORTANT: End <b>without</b> a slash or backslash!");
define("_ZOOM_YES","yes");
define("_ZOOM_NO","no");
define("_ZOOM_SAVE","Save");
define("_ZOOM_MOVEFILES","Move media");
define("_ZOOM_MOVEFILES_DESCR","move a medium from one gallery to another.");
define("_ZOOM_BUTTON_MOVE","Move");
define("_ZOOM_MOVEFILES_STEP1","Step 1: Select source gallery");
define("_ZOOM_MOVEFILES_STEP2","Step 2: Select the media you want to move");
define("_ZOOM_MOVEFILES_STEP3","Step 3: Select target gallery & move media");
define("_ZOOM_ALERT_MOVEOK","Media succesfully moved!");
...
define("_ZOOM_UPDATE_DESCR","add new features, solve problems and resolve bugs! Check <a href=\"http://zoom.ummagumma.nl\" target=\"_blank\">zoom.ummagumma.nl</a> for the latest update!");
...
define("_ZOOM_M_method","View method");
define("_ZOOM_M_all","all");
define("_ZOOM_M_random","random");
define("_ZOOM_M_newest","new");
define("_ZOOM_M_hits","hits");
define("_ZOOM_M_votes","votes");
define("_ZOOM_M_count","Number of pics:"); 
define("_ZOOM_M_lastup","Last update:");
define("_ZOOM_M_admin_count","Show number of pics:");
define("_ZOOM_M_admin_lastup","Show last update:");
define("_ZOOM_M_admin_cats","Show catnames:");
define("_ZOOM_M_admin_meth","Show method:");
define("_ZOOM_M_admin_df","Dateformat (j M, H:i):");
?>
