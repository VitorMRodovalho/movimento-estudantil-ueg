...
define("_ZOOM_MEDIAMGR_DESCR","bewerk, verwijder, scan media of upload zelf uw nieuwe media handmatig.");
...
define("_ZOOM_SETTINGS_TAB1","Locaties & Conversie");
define("_ZOOM_SETTINGS_TAB2","Weergave");
define("_ZOOM_SETTINGS_TAB4","Gebruikerstoegang");
...
define("_ZOOM_SETTINGS_ACCESSLVL","Toegangsniveau: ");
...
define("_ZOOM_SETTINGS_ALLOWCREATE","Aanmaken galerij toestaan");
define("_ZOOM_SETTINGS_ALLOWDEL","Verwijderen gedeelde galerij toestaan");
define("_ZOOM_SETTINGS_ALLOWEDIT","Bewerken (gedeelde) galerij toestaan");
...
define("_ZOOM_SETTINGS_MESS_FTPHOSTDIR","Vul hier het pad naar uw Mambo installatie in vanaf uw ftp-root.");
define("_ZOOM_YES","ja");
define("_ZOOM_NO","nee");
define("_ZOOM_SAVE","Opslaan");
define("_ZOOM_RESET","Reset");
define("_ZOOM_MOVEFILES","Verplaats media");
define("_ZOOM_MOVEFILES_DESCR","verplaats een medium van de ene galerij naar de andere.");
define("_ZOOM_BUTTON_MOVE","Verplaats");
define("_ZOOM_ALERT_MOVEOK","Media succevol verplaatst!");
define("_ZOOM_MOVEFILES_STEP1","Stap 1: Selecteer de brongalerij");
define("_ZOOM_MOVEFILES_STEP2","Stap 2: Selecteer media die u wilt verplaatsen");
define("_ZOOM_MOVEFILES_STEP3","Stap 3: Selecteer de doelgalerij & verplaats de media");
...
define("_ZOOM_UPDATE_DESCR","voeg nieuwe functionaliteit toe, los problemen op en verhelp bugs! Check <a href=\"http://zoom.ummagumma.nl\" target=\"_blank\">zoom.ummagumma.nl</a> voor de meest recente update!");
...
//Module Language
define("_ZOOM_M_config","Module configuratie");
define("_ZOOM_M_method","Weergave methode");
define("_ZOOM_M_all","alle methoden");
define("_ZOOM_M_random","willekeurig");
define("_ZOOM_M_newest","nieuw");
define("_ZOOM_M_hits","hits");
define("_ZOOM_M_votes","stemmen");
define("_ZOOM_M_count","Number of pics:"); 
define("_ZOOM_M_lastup","Last update:");
define("_ZOOM_M_admin_count","Aantal media weergeven:");
define("_ZOOM_M_admin_lastup","Laatste Update weergeven:");
define("_ZOOM_M_admin_cats","Galerij-naam weergeven:");
define("_ZOOM_M_admin_meth","Methode weergeven:");
define("_ZOOM_M_admin_df","Datum formaat (j M, H:i):");
?>
