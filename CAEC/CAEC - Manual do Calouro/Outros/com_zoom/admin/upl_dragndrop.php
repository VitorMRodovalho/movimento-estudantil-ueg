...
if (!isset($catid)){
	...
	$theId = mosGetParam($_REQUEST,'catid');
	$theUid = mosGetParam($_REQUEST,'uid');
}
$zoom->createFormControlScript("JUploadForm");
?>
<div align="center">
 <form name="JUploadForm" method="post" action="index<?php echo ($zoom->_isBackend) ? "2" : "";?>.php?option=com_zoom&Itemid=<?php echo $Itemid;?>&page=upload&formtype=dragndrop">
  <input type="hidden" name="dnd_uid" value="<?php echo $zoom->_CurrUID;?>">
	<?php
 ...
 <applet 
  ...
  archive="<?php echo $mosConfig_live_site;?>/components/com_zoom/admin/JUpload.jar"
  width="600"
  height="300"
  name="JUpload"
  alt="JUpload applet">
 ...
 <!-- Target links -->
 <param name="actionURL" value="<?php echo ($zoom->_isBackend) ? "../" : $mosConfig_live_site."/";?>components/com_zoom/save_dnd.php?catid=<?php echo $theId;?>&uid=<?php echo $theUid;?>">
 <param name="imageURL" value="<?php echo $mosConfig_live_site;?>/components/com_zoom/images/zoom_dragndrop.gif">
